...
import "github.com/tncheng/multipipelinehs/crypto"
...
func (b *BlockContainer) Level() uint64               { return uint64(b.Block.Seq) }
func (b *BlockContainer) Parent() (crypto.Identifier, uint64) {
	return b.Block.PrevID, uint64(b.Block.QC.Seq)
}
