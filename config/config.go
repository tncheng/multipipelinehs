...
var configFile = flag.String("config", "config.json", "Configuration file for multipipelinehs replica. Defaults to config.json.")
...
type Config struct {
	...
	ShareInterval  int             `json:"share_interval"`
